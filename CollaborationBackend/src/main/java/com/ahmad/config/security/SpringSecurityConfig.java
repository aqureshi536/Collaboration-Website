...
/*		http.csrf().disable().authorizeRequests().antMatchers("/user/**").access("hasRole('ROLE_STUDENT')").and().httpBasic();
		http.csrf().disable().authorizeRequests().antMatchers("/user/**").access("hasRole('ROLE_ALUMNI')").and().httpBasic();
		http.csrf().disable().authorizeRequests().antMatchers("/user/**").access("hasRole('ROLE_EMPLOYEE')").and().httpBasic();
		http.csrf().disable().authorizeRequests().antMatchers("/admin/**").access("hasRole('ROLE_ADMIN')").and().httpBasic();*/
		//http.csrf().disable().authorizeRequests().antMatchers("/user/**").access("hasRole('ROLE_STUDENT')").and().httpBasic();
		http.csrf().disable().authorizeRequests().antMatchers("/user/**").access("hasAnyRole('ROLE_STUDENT,ROLE_ALUMNI,ROLE_EMPLOYEE,ROLE_ADMIN')").and().httpBasic();
	}
